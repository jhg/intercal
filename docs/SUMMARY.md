...
- [What is INTERCAL?](what-is-intercal.md)
- [Getting started](getting-started.md)
- [INTERCAL primer](intercal-primer.md)
- [Label 666: a gentle introduction](label-666-intro.md)

# Part II: Touring the compiler

- [Overview](overview.md)
- [Map of the compiler](map-of-the-compiler.md)
- [The compilation pipeline](pipeline.md)
- [Walkthrough: Hello, World!](walkthrough-hello.md)

# Part III: The front end

- [Lexer theory](lexer-theory.md)
- [Parser theory](parser-theory.md)
- [Lexing and parsing in practice](lexing-and-parsing.md)
- [Semantic analysis](semantic-analysis.md)

# Part IV: The back end

- [Code generation](code-generation.md)
- [The middle end we don't have](middle-end-and-optimisation.md)
- [The runtime](runtime.md)
- [The system library](syslib.md)
...
- [Formal grammar (EBNF)](appendix-grammar.md)
- [Glossary](glossary.md)
- [Further reading](further-reading.md)
- [Exercise hints](appendix-exercise-hints.md)
- [Label 666: deep design rationale](666.md)

---

[INTERCAL programming patterns](intercal_patterns.md)
