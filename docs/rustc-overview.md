...
- **In progress (2024-2026)**: **Polonius**, a re-implementation of the borrow checker as a Datalog program. The algorithm is fundamentally different (logic-based rather than dataflow-based), more permissive in edge cases, and easier to extend with new rules.
...
rustc bootstraps in three stages:
