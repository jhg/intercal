...
_stmt_1:  // ARRAY_DIM
  ...
  adrp x12, _tail_1_dims@PAGE
  add x12, x12, _tail_1_dims@PAGEOFF
  str w11, [x12, #0]
  mul w10, w10, w11
  add sp, sp, #16
  adrp x12, _tail_1_ndim@PAGE
  add x12, x12, _tail_1_ndim@PAGEOFF
  mov w11, #1
  str w11, [x12]
  lsl x0, x10, #1
  bl _rt_mmap
  adrp x12, _tail_1_ptr@PAGE
  add x12, x12, _tail_1_ptr@PAGEOFF
  str x0, [x12]
_stmt_1_end:
...
_stmt_2:  // ASSIGN
  ...
  cmp w0, w2
  b.hs _rt_error_E241
  adrp x1, _tail_1_ign@PAGE
  add x1, x1, _tail_1_ign@PAGEOFF
  ldrb w2, [x1]
