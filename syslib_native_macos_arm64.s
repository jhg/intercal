// syslib_native_macos_arm64.s - Native INTERCAL syslib for macOS ARM64
...
_rt_syslib_1050:
  adrp x0, _twospot_1@PAGE
  add x0, x0, _twospot_1@PAGEOFF
  ldr w1, [x0]
  adrp x0, _spot_1@PAGE
  add x0, x0, _spot_1@PAGEOFF
  ldr w2, [x0]
...
_rt_syslib_1500:
  ...
  add x0, x0, _twospot_1@PAGEOFF
  ldr w1, [x0]
  adrp x0, _twospot_2@PAGE
  add x0, x0, _twospot_2@PAGEOFF
  ldr w2, [x0]
  adds w3, w1, w2
  b.cs _rt_syslib_1999
  adrp x0, _twospot_3@PAGE
  add x0, x0, _twospot_3@PAGEOFF
  str w3, [x0]
  b _rt_resume_1
...
_rt_syslib_1509:
  ...
  add x0, x0, _twospot_3@PAGEOFF
  str w3, [x0]
  adrp x0, _twospot_4@PAGE
  add x0, x0, _twospot_4@PAGEOFF
  str w5, [x0]
  b _rt_resume_1
...
_rt_syslib_1520:
  ...
  ldr w1, [x1]
  bl _rt_mingle
  adrp x1, _twospot_1@PAGE
  add x1, x1, _twospot_1@PAGEOFF
  str w0, [x1]
  b _rt_resume_1
